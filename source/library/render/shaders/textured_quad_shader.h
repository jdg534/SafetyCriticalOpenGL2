...
static constexpr std::string_view TEXTURED_QUAD_VERTEX_SHADER = R"(#version 100
...
static constexpr std::string_view TEXTURED_QUAD_FRAGMENT_SHADER = R"(#version 100
